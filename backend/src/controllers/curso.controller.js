 ...
 * Lógica: Listar, crear, actualizar (bloqueado si hay grupos finalizados), desactivar.
 * Nota: todos los cursos son certificables por defecto (certificable=1 fijo en DB).
 * Nota: Los cursos NUNCA se eliminan físicamente — solo se desactivan (activo=0).
 */
